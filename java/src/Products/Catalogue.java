...
public class Catalogue {
	...
	public Catalogue() {
		...
		products.add(new Sku("5990", "Raffle ticket", "Players must be 16 or over and physically located in the UK or Isle of Man", 50));
		products.add(new Sku("6000", "Top hat, black, large", "A soft black wool Top Hat with 4cm ribbon band and bow. Fully lined, complete with a leather band. This traditional gentlemen’s top hat is suitable for all formal events; from weddings to a day at the races.", 4699));
	}

	public void list(PrintStream out) {
		for (Sku sku : products)											// TODO -- sort by sku
